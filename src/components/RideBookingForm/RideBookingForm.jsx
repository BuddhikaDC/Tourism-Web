    ...
    <div className="w-full max-w-6xl mx-auto px-0 sm:px-0 lg:px-0">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-stretch">
        ...
        <div className="md:w-7/12 w-full flex flex-col justify-center py-2 md:py-0 pl-0">
          <h1 className="text-4xl sm:text-6xl font-extrabold text-gray-900 mb-7 leading-tight max-w-[800px]">
            Book a <span className="text-emerald-600 italic font-extrabold">Ride</span><br />
            to your destination<br />
            in Sri Lanka
          </h1>
          <p className="text-gray-700 text-lg sm:text-2xl font-medium mb-8 max-w-[650px]">
      ...
      <section className="mt-16 mb-10 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
          {vehicles.map((vehicle, idx) => (
            <div
              key={vehicle.name}
              className="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-emerald-200 hover:-translate-y-1"
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center justify-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-full transition-all duration-200 hover:shadow-lg hover:scale-105"
