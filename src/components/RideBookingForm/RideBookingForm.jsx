...
function RideBookingForm() {
  ...
  const vehicles = [
    { name: 'Wagon R', price: 'Rs. 47/Km', img: '/images/wagonr.jpg' },
    { name: 'Alto', price: 'Rs. 45/Km', img: '/images/alto.jpg' },
    { name: 'Nano', price: 'Rs. 47/Km', img: '/images/nano.jpg' },
    { name: 'Mini Van', price: 'Rs. 47/Km', img: '/images/minivan.jpg' },
    { name: 'Prius', price: 'Rs. 55/Km', img: '/images/prius.jpg' },
    { name: 'KDH', price: 'Rs. 60/Km', img: '/images/kdh.jpg' },
    { name: 'Dimo Batta', price: 'Rs. 47/Km', img: '/images/dimobatta.jpg' },
    { name: 'Bolero', price: 'Rs. 55/Km', img: '/images/bolero.jpg' }
  ]
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-6">
          {vehicles.map((vehicle) => (
            <div key={vehicle.name} className="flex flex-col items-center">
              ...
              />
              <div className="text-2xl font-bold text-gray-900 dark:text-white text-center">{vehicle.name}</div>
              <div className="text-lg text-gray-700 dark:text-gray-300 text-center">{vehicle.price}</div>
            </div>
          ))}
        </div>
      </section>
