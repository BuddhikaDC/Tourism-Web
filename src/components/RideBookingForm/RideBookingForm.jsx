      ...
      <section className="mt-16 mb-10 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {vehicles.map((vehicle) => (
            <div
              key={vehicle.name}
              className="group rounded-xl border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-800/70 backdrop-blur-sm p-4 transition hover:shadow-xl hover:border-emerald-500/40 dark:hover:border-emerald-500/30"
            >
              ...
              <div className="mt-4 flex items-start justify-between gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1 rounded-full bg-emerald-600 px-3 py-2 text-xs font-semibold text-white shadow-md transition hover:bg-emerald-500"
